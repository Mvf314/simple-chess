...
g++ -c src\random.cpp -o bin\random.o %FLAGS%
...
g++ -o chess.exe bin\position.o bin\piece.o bin\king.o bin\queen.o bin\rook.o bin\bishop.o bin\knight.o bin\pawn.o bin\random.o bin\game.o bin\main.o %FLAGS%
